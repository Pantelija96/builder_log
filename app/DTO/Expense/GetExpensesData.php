...
{
    public function __construct(public ListQueryData $list, public ?string $search, public ?string $title, public ?int $createdBy,
                                public ?Carbon $dateFrom, public ?Carbon $dateTo, public ?float $minAmount, public ?float $maxAmount,
                                public ?int $constructionSiteId, public ?int $siteManagerId,) {
    }
